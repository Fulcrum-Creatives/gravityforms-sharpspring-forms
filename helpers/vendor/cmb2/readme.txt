...
* Fix repeating fields not working correctly if meta key or gfssf contained an integer. ([#503](https://github.com/WebDevStudios/Custom-Metaboxes-and-Fields-for-WordPress/issues/503))
